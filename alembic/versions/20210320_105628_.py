...
def upgrade():
    ...
    op.add_column('trade_bots', sa.Column('close_order_finalized', sa.JSON(), nullable=True))
    op.add_column('trade_bots', sa.Column('entry_order_finalized', sa.JSON(), nullable=True))
