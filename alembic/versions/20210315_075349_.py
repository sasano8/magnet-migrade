...
def downgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "order_type", sa.VARCHAR(length=255), autoincrement=False, nullable=False
        ),
        sa.Column(
            "broker", sa.VARCHAR(length=1024), autoincrement=False, nullable=False
        ),
