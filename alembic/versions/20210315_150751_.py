...
def upgrade():
    ...
    op.add_column('__crypto_ohlc_daily', sa.Column('optn_time', sa.Date(), nullable=True))
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('__crypto_ohlc_daily', sa.Column('start_time', sa.DATE(), autoincrement=False, nullable=True))
